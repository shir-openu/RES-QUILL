...
void main() {
  ...
  testWidgets('capture T47 validation value cards', (tester) async {
    addTearDown(tester.view.resetPhysicalSize);
    addTearDown(tester.view.resetDevicePixelRatio);

    final configs = [
      _CaptureConfig(
        't47_bright_desktop_1440x1000_validation',
        const Size(1440, 1000),
        light: true,
      ),
      _CaptureConfig(
        't47_dark_desktop_1440x1000_validation',
        const Size(1440, 1000),
        light: false,
      ),
      _CaptureConfig(
        't47_bright_mobile_390x900_validation',
        const Size(390, 900),
        light: true,
      ),
      _CaptureConfig(
        't47_dark_mobile_390x900_validation',
        const Size(390, 900),
        light: false,
      ),
    ];
